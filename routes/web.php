...
Route::prefix("admin")->as("admin.")->middleware("loginControl")->group(function () {
    ...
    Route::prefix("/setting")->as("setting.")->group(function () {
        ...
        Route::get("/carousel.html", [admin\setting\indexController::class, "carousel"])->name("carousel");
        Route::post("/carousel", [admin\setting\indexController::class, "carouselPost"])->name("carouselPost");
        Route::get("/carouseldestroy/{id}", [admin\setting\indexController::class, "carouselDestroy"])->name("carouselDestroy");
    });
