...
<div class="boxed_wrapper home_3">
    ...
    <header class="main-header header-style-three">
        ...
        <div class="header-lower">
            <div class="outer-container">
                <div class="outer-box">
                    <div class="logo-box">
                        <figure class="logo"><a href="{{ route("indexHtmlTR") }}"><img
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="index.html">Kurumsal</a>
                                        <ul>
                    ...
                    <div class="menu-right-content">
                        <div class="user-box"><a href="{{ route("indexHtmlEN") }}"><img src="{{ asset("asset/front/usa.svg") }}" width="50" alt=""></a></div>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="{{ route("indexHtmlTR") }}"><img src="{{ asset("imageAvif/setting/")."/".\App\Models\setting::getSetting("logoHeaderAvif") }}" alt="" title=""></a></div>
            <div class="menu-outer">
                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                    <ul class="navigation clearfix">
                <li><a href="{{ route("indexHtmlEN") }}" class="flagMobile"  ><img src="{{ asset("asset/front/usa.svg") }}" width="30" alt=""> English</a></li>
                    </ul>
                </div>
            </div>
