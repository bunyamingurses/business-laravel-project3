                            ...
                            <div class="widget-content">
                                <ul class="category-list clearfix">
                                    ...
                                    @foreach($popular as $popularWrite)
                                        <li>
                                            <a href="{{ route("productDetailHtmlEN",["id"=>$popularWrite->id,"name"=>\App\Http\Controllers\support\functionController::seo($popularWrite->titleEnglish)]) }}" class="sec-btn" title="{{ $popularWrite->titleEnglish }}">{{ $popularWrite->titleEnglish }}</a>
                                        </li>
                                    @endforeach
                                            ...
                                            <div class="inner-box">
                                                <div class="image-box mb-0">
                                                    ...
                                                    <div class="lower-content bg-light">
                                                        <h3>{{ $galleryWrite->nameEnglish }}</h3>
                                                    </div>
                                                </div>
